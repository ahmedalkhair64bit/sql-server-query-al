...
import { createPlanParser } from "./plan-parser.mjs";
...
try {
  ...
  const parser = createPlanParser((d) => {
    ...
    // Suggest the statement that actually took longest when the plan measured it; otherwise the
    // costliest estimate. Measured time outranks any estimate.
    const weight =
